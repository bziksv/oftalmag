...
$APPLICATION->SetPageProperty("description", "Актуальные акции и скидки на медицинские товары интернет-магазина Оftalmag | Телефон +7-499-113-23-88");
$APPLICATION->SetPageProperty("title", "Акции и скидки | Интернет-магазин медицинского оборудования Оftalmag");
