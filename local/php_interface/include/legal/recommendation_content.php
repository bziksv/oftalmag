...
<div class="legal-doc">
	...
	<ul>
		<?php $withOperatorPrefix = false; include __DIR__ . '/third_parties_list.php'; ?>
	</ul>
	...
	<p>9. Настоящие Правила действуют бессрочно до замены новой версией. Актуальная редакция размещается на Сайте по адресу <?= legal_image_link($legal, 'recommendation') ?>.</p>
