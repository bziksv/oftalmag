...
<link rel="icon" href="https://oftalmag.ru/favicon.ico" type="image/x-icon">
...
?>
					...
					<div class="top-panel__cols">
						<div class="top-panel__col top-panel__thead">								
							<div class="top-panel__cols">								
								...
								<?}
								//LOGO//?>								
								<div class="top-panel__col top-panel__logo hidden-xs">
	...
	false
                                ...
                                <div class="top_panel__search only_mob">
											...
											<div class="top-panel__search <?=($arSettings['TOP_PANEL_SEARCH_BUTTON']['VALUE'] != 'Y' ? 'hidden-xs hidden-sm' : 'hidden')?>">
												...
												if($arSettings["MAIN_SEARCH"]["VALUE"] == "BITRIX") {?>
													<?$APPLICATION->IncludeComponent("bitrix:main.include", "",
														array(
															"AREA_FILE_SHOW" => "file",
															"PATH" => SITE_DIR."include/header_search_m.php"
														),
														false,
														array("HIDE_ICONS" => "Y")
													);?>
