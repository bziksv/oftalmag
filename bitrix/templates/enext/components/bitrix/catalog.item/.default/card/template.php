...
<div class="product-item">	
	<div class="product-item-image-wrapper" data-entity="image-wrapper">		
		<?//PREVIEW_PICTURE//?>
		<a target="_self" class="product-item-image" id="<?=$itemIds['PICT_ID']?>" href="/product/<?=$item['CODE']?>/" title="<?=$imgTitle?>"<?=($arParams["QUICK_VIEW"] == "FULL" ? " data-entity='quickView'" : "")?>>
	...
	<div class="product-item-title">
		<a target="_self" href="/product/<?=$item['CODE']?>/" title="<?=$item['NAME']?>"<?=($arParams["QUICK_VIEW"] == "FULL" ? " data-entity='quickView'" : "")?>><?=$item['NAME']?></a>
	</div>
	<?//RATING//
