					...
					<a href="<?=$arItem['LINK']?>" class="catalog-section-item">
						...
						<span class="catalog-section-item__graph-wrapper">
							<span class="catalog-section-item__graph<?=(!empty($arItem["PARAMS"]["ICON"]) || is_array($arItem["PARAMS"]["PICTURE"]) ? '' : ' empty')?>">
								...
								<?} else {?>
									<img src ="/bitrix/images/arturgolubev.lazyload/pixel.gif" data-lazyload-src="<?=SITE_TEMPLATE_PATH?>/images/no_photo.png" width="134" height="134" alt="<?=$arItem['PARAMS']['PICTURE']['ALT']?>" title="<?=$arItem['PARAMS']['PICTURE']['TITLE']?>" />
								<?}?>
							</span>
						</span>
