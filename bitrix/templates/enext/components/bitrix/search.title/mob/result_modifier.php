...
$arResult["SECTIONS"] = [];
$db_old_groups = CIBlockElement::GetElementGroups($arResult["ELEMENTS"], true, ["ID", "NAME", "CODE", "PICTURE"]);
while($ar_group = $db_old_groups->Fetch())
{		
	$arResult["SECTIONS"][$ar_group["ID"]] = $ar_group;
	$arResult["SECTIONS"][$ar_group["ID"]]["PICTURE"] = CFile::GetPath($ar_group["PICTURE"]);
}
