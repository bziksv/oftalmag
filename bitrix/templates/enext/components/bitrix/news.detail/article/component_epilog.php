	...
	foreach($matches as $match) {
		...
		$APPLICATION->IncludeComponent("bitrix:catalog.element", "article",
			array(
				...
				"OFFERS_PROPERTY_CODE" => $arParams["CATALOG_DETAIL_OFFERS_PROPERTY_CODE"],
				...
				"MAIN_BLOCK_PROPERTY_CODE" => $arParams["CATALOG_DETAIL_MAIN_BLOCK_PROPERTY_CODE"],
		...
		$arResult["RESULT_HTML"] = str_replace($match[0], $output, $arResult["RESULT_HTML"]);
	}
	unset($match);
}
unset($matches, $regex);
