		...
		<div class="articles-item-detail-pic-container">
			<div class="articles-item-detail-pic">
				<?if(is_array($arResult["DETAIL_PICTURE"])) {?>
					<img width="<?=$arResult['DETAIL_PICTURE']['WIDTH']?>" height="<?=$arResult['DETAIL_PICTURE']['HEIGHT']?>" src="<?=$arResult['DETAIL_PICTURE']['SRC']?>" alt="<?=$arResult['DETAIL_PICTURE']['ALT']?>" />
				<?}?>
			</div>
		</div>
		<?//ITEM_BLOCK//?>
...
<?if($hasProducts) {
	...
	<script type="text/javascript">
		BX.message({
			ARTICLES_ITEM_DETAIL_PRODUCTS_SECTIONS_ALL: '<?=GetMessageJS("ARTICLES_ITEM_DETAIL_PRODUCTS_SECTIONS_ALL")?>',
			ARTICLES_ITEM_DETAIL_PRODUCTS_SECTIONS_SHOW_ALL: '<?=GetMessageJS("ARTICLES_ITEM_DETAIL_PRODUCTS_SECTIONS_SHOW_ALL")?>',
			ARTICLES_ITEM_DETAIL_PRODUCTS_SECTIONS_HIDE: '<?=GetMessageJS("ARTICLES_ITEM_DETAIL_PRODUCTS_SECTIONS_HIDE")?>',
