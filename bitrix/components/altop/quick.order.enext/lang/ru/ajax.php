<?
$MESS["QUICK_ORDER_AJAX_PROP_OBJECT_ID_NAME"] = "ID объекта";
$MESS["QUICK_ORDER_AJAX_PROP_OBJECT_NAME_NAME"] = "Название объекта";
...
$MESS["QUICK_ORDER_AJAX_EVENT_MESSAGE_MESSAGE"] = "Стоимость заказа: #PRICE#<br/><br/>Состав заказа:<br/>#ORDER_LIST#<br/><br/>Заказчик:<br/>Имя: #NAME#<br/>Телефон: #PHONE#<br/>Email: #EMAIL#<br/>Комментарии к заказу: #COMMENTS#<br/><br/>Сообщение сгенерировано автоматически.";
$MESS["QUICK_ORDER_AJAX_ORDER_CREATE_SUCCESS"] = "Ваш заказ №#ORDER_ID# от #ORDER_DATE# успешно создан.<br /><br />
После проверки заказа и уточнений по срокам поставки, менеджер направит Вам счет на e-mail.<br />
Если потребуется уточнения, менеджер также отпишется Вам на e-mail.<br />
<br />
";
