...
$defaultValue = array("-" => GetMessage("CP_SBB_TPL_DEFAULT_VALUE"));
...
$arAscDesc = array(
	"asc" => GetMessage("CP_SBB_TPL_SORT_ASC"),
	"desc" => GetMessage("CP_SBB_TPL_SORT_DESC"),
);
...
$arTemplateParameters["CATALOG_IBLOCK_TYPE"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_IBLOCK_TYPE"),
	"TYPE" => "LIST",		
	"REFRESH" => "Y",
	"VALUES" => $arIBlockType,
);	
...
$arTemplateParameters["CATALOG_IBLOCK_ID"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_IBLOCK_ID"),
	"TYPE" => "LIST",
	"REFRESH" => "Y",		
...
$arTemplateParameters["CATALOG_ELEMENT_SORT_FIELD"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_ELEMENT_SORT_FIELD"),
	"TYPE" => "LIST",
	"VALUES" => $arSort,
	"ADDITIONAL_VALUES" => "Y",
	"DEFAULT" => "sort",
...
$arTemplateParameters["CATALOG_ELEMENT_SORT_ORDER"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_ELEMENT_SORT_ORDER"),
	"TYPE" => "LIST",
	"VALUES" => $arAscDesc,
	"DEFAULT" => "asc",
	"ADDITIONAL_VALUES" => "Y",
...
$arTemplateParameters["CATALOG_ELEMENT_SORT_FIELD2"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_ELEMENT_SORT_FIELD2"),
	"TYPE" => "LIST",
	"VALUES" => $arSort,
	"ADDITIONAL_VALUES" => "Y",
	"DEFAULT" => "id",
...
$arTemplateParameters["CATALOG_ELEMENT_SORT_ORDER2"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_ELEMENT_SORT_ORDER2"),
	"TYPE" => "LIST",
	"VALUES" => $arAscDesc,
	"DEFAULT" => "desc",
	"ADDITIONAL_VALUES" => "Y",
...
$arTemplateParameters["CATALOG_INCLUDE_SUBSECTIONS"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_INCLUDE_SUBSECTIONS"),
	"TYPE" => "LIST",
	"VALUES" => array(
		"Y" => GetMessage("CP_SBB_TPL_CATALOG_INCLUDE_SUBSECTIONS_ALL"),
		"A" => GetMessage("CP_SBB_TPL_CATALOG_INCLUDE_SUBSECTIONS_ACTIVE"),
		"N" => GetMessage("CP_SBB_TPL_CATALOG_INCLUDE_SUBSECTIONS_NO"),
	),
	"DEFAULT" => "Y",
);

$arTemplateParameters["CATALOG_USE_MAIN_ELEMENT_SECTION"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_USE_MAIN_ELEMENT_SECTION"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "N",
);

$arTemplateParameters["CATALOG_PROPERTY_CODE"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_PROPERTY_CODE"),
	"TYPE" => "LIST",
	"MULTIPLE" => "Y",	
...
$arTemplateParameters["CATALOG_OFFERS_FIELD_CODE"] = CIBlockParameters::GetFieldCode(GetMessage("CP_SBB_TPL_CATALOG_OFFERS_FIELD_CODE"), "ADDITIONAL_SETTINGS");

$arTemplateParameters["CATALOG_OFFERS_PROPERTY_CODE"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_OFFERS_PROPERTY_CODE"),
	"TYPE" => "LIST",
	"MULTIPLE" => "Y",
...
$arTemplateParameters["CATALOG_OFFERS_LIMIT"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_OFFERS_LIMIT"),
	"TYPE" => "STRING",
	"DEFAULT" => 0
);

$arTemplateParameters["CATALOG_OFFERS_SORT_FIELD"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_OFFERS_SORT_FIELD"),
	"TYPE" => "LIST",
	"VALUES" => $arOfferSort,
	"ADDITIONAL_VALUES" => "Y",
	"DEFAULT" => "sort",
...
$arTemplateParameters["CATALOG_OFFERS_SORT_ORDER"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_OFFERS_SORT_ORDER"),
	"TYPE" => "LIST",
	"VALUES" => $arAscDesc,
	"DEFAULT" => "asc",
	"ADDITIONAL_VALUES" => "Y",
...
$arTemplateParameters["CATALOG_OFFERS_SORT_FIELD2"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_OFFERS_SORT_FIELD2"),
	"TYPE" => "LIST",
	"VALUES" => $arOfferSort,
	"ADDITIONAL_VALUES" => "Y",
	"DEFAULT" => "id",
...
$arTemplateParameters["CATALOG_OFFERS_SORT_ORDER2"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_OFFERS_SORT_ORDER2"),
	"TYPE" => "LIST",
	"VALUES" => $arAscDesc,
	"DEFAULT" => "desc",
	"ADDITIONAL_VALUES" => "Y",
...
$arTemplateParameters["CATALOG_MESS_BTN_BUY"] = array(	
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MESS_BTN_BUY"),
	"TYPE" => "STRING",
	"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_MESS_BTN_BUY_DEFAULT")
);

$arTemplateParameters["CATALOG_MESS_BTN_ADD_TO_BASKET"] = array(	
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MESS_BTN_ADD_TO_BASKET"),
	"TYPE" => "STRING",
	"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_MESS_BTN_ADD_TO_BASKET_DEFAULT")
);

$arTemplateParameters["CATALOG_MESS_BTN_SUBSCRIBE"] = array(	
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MESS_BTN_SUBSCRIBE"),
	"TYPE" => "STRING",
	"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_MESS_BTN_SUBSCRIBE_DEFAULT")
);

$arTemplateParameters["CATALOG_MESS_BTN_DETAIL"] = array(	
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MESS_BTN_DETAIL"),
	"TYPE" => "STRING",
	"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_MESS_BTN_DETAIL_DEFAULT")
);

$arTemplateParameters["CATALOG_MESS_NOT_AVAILABLE"] = array(	
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MESS_NOT_AVAILABLE"),
	"TYPE" => "STRING",
	"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_MESS_NOT_AVAILABLE_DEFAULT")
);

$arTemplateParameters["CATALOG_PRICE_CODE"] = array(		
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_PRICE_CODE"),
	"TYPE" => "LIST",
	"MULTIPLE" => "Y",
	"VALUES" => $arPrice,
);
...
$arTemplateParameters["CATALOG_USE_PRICE_COUNT"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_USE_PRICE_COUNT"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
);

$arTemplateParameters["CATALOG_SHOW_PRICE_COUNT"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_SHOW_PRICE_COUNT"),
	"TYPE" => "STRING",
	"DEFAULT" => "1",
);

$arTemplateParameters["CATALOG_PRICE_VAT_INCLUDE"] = array(		
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_PRICE_VAT_INCLUDE"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
);

$arTemplateParameters["CATALOG_BASKET_URL"] = array(	
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_BASKET_URL"),
	"TYPE" => "STRING",
	"DEFAULT" => "/personal/cart/",
);

$arTemplateParameters["CATALOG_USE_PRODUCT_QUANTITY"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_USE_PRODUCT_QUANTITY"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
	"REFRESH" => "Y",
);
...
$arTemplateParameters["CATALOG_ADD_PROPERTIES_TO_BASKET"] = array(	
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_ADD_PROPERTIES_TO_BASKET"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
	"REFRESH" => "Y"
);
...
$arTemplateParameters["CATALOG_PARTIAL_PRODUCT_PROPERTIES"] = array(	
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_PARTIAL_PRODUCT_PROPERTIES"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
...
$arTemplateParameters["CATALOG_PRODUCT_PROPERTIES"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_PRODUCT_PROPERTIES"),
	"TYPE" => "LIST",
	"MULTIPLE" => "Y",
...
if($catalogIncluded) {
	$arTemplateParameters["CATALOG_HIDE_NOT_AVAILABLE"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_HIDE_NOT_AVAILABLE"),
		"TYPE" => "LIST",
		"DEFAULT" => "N",
		"VALUES" => array(
			"Y" => GetMessage("CP_SBB_TPL_CATALOG_HIDE_NOT_AVAILABLE_HIDE"),
			"L" => GetMessage("CP_SBB_TPL_CATALOG_HIDE_NOT_AVAILABLE_LAST"),
			"N" => GetMessage("CP_SBB_TPL_CATALOG_HIDE_NOT_AVAILABLE_SHOW")
		),
		"ADDITIONAL_VALUES" => "N"
	);
	
	$arTemplateParameters["CATALOG_HIDE_NOT_AVAILABLE_OFFERS"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_HIDE_NOT_AVAILABLE_OFFERS"),
		"TYPE" => "LIST",
		"DEFAULT" => "N",
		"VALUES" => array(
			"Y" => GetMessage("CP_SBB_TPL_CATALOG_HIDE_NOT_AVAILABLE_OFFERS_HIDE"),
			"L" => GetMessage("CP_SBB_TPL_CATALOG_HIDE_NOT_AVAILABLE_OFFERS_SUBSCRIBE"),
			"N" => GetMessage("CP_SBB_TPL_CATALOG_HIDE_NOT_AVAILABLE_OFFERS_SHOW")
		)
	);

	$arTemplateParameters["CATALOG_PRODUCT_SUBSCRIPTION"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_PRODUCT_SUBSCRIPTION"),
		"TYPE" => "CHECKBOX",
		"DEFAULT" => "Y"
	);

	$arTemplateParameters["CATALOG_SHOW_DISCOUNT_PERCENT"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_SHOW_DISCOUNT_PERCENT"),
		"TYPE" => "CHECKBOX",
		"REFRESH" => "Y",
		"DEFAULT" => "Y"
	);
	...
	$arTemplateParameters["CATALOG_SHOW_OLD_PRICE"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_SHOW_OLD_PRICE"),
		"TYPE" => "CHECKBOX",
		"DEFAULT" => "Y"
	);

	$arTemplateParameters["CATALOG_SHOW_MAX_QUANTITY"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_SHOW_MAX_QUANTITY"),
		"TYPE" => "LIST",
		"REFRESH" => "Y",
		"MULTIPLE" => "N",
		"VALUES" => array(
			"N" => GetMessage("CP_SBB_TPL_CATALOG_SHOW_MAX_QUANTITY_N"),
			"Y" => GetMessage("CP_SBB_TPL_CATALOG_SHOW_MAX_QUANTITY_Y"),
			"M" => GetMessage("CP_SBB_TPL_CATALOG_SHOW_MAX_QUANTITY_M")
		),
		"DEFAULT" => array("M"),
	);
	...
	if(isset($arCurrentValues["CATALOG_SHOW_MAX_QUANTITY"])) {
		if($arCurrentValues["CATALOG_SHOW_MAX_QUANTITY"] !== "N") {
			$arTemplateParameters["CATALOG_MESS_SHOW_MAX_QUANTITY"] = array(				
				"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MESS_SHOW_MAX_QUANTITY"),
				"TYPE" => "STRING",
				"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_MESS_SHOW_MAX_QUANTITY_DEFAULT")
			);
		}

		if($arCurrentValues["CATALOG_SHOW_MAX_QUANTITY"] === "M") {
			$arTemplateParameters["CATALOG_RELATIVE_QUANTITY_FACTOR"] = array(				
				"NAME" => GetMessage("CP_SBB_TPL_CATALOG_RELATIVE_QUANTITY_FACTOR"),
				"TYPE" => "STRING",
				"DEFAULT" => "5"
			);
			$arTemplateParameters["CATALOG_MESS_RELATIVE_QUANTITY_MANY"] = array(				
				"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MESS_RELATIVE_QUANTITY_MANY"),
				"TYPE" => "STRING",
				"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_MESS_RELATIVE_QUANTITY_MANY_DEFAULT")
			);
			$arTemplateParameters["CATALOG_MESS_RELATIVE_QUANTITY_FEW"] = array(				
				"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MESS_RELATIVE_QUANTITY_FEW"),
				"TYPE" => "STRING",
				"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_MESS_RELATIVE_QUANTITY_FEW_DEFAULT")
			);
		}
	}

	$arTemplateParameters["CATALOG_ADD_TO_BASKET_ACTION"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_ADD_TO_BASKET_ACTION"),
		"TYPE" => "LIST",
		"VALUES" => array(
	...
	$arTemplateParameters["CATALOG_CONVERT_CURRENCY"] = array(				
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_CONVERT_CURRENCY"),
		"TYPE" => "CHECKBOX",				
		"REFRESH" => "Y",
		"DEFAULT" => "N",
	);
	...
	if(isset($arCurrentValues["CATALOG_CONVERT_CURRENCY"]) && $arCurrentValues["CATALOG_CONVERT_CURRENCY"] === "Y") {
		$arTemplateParameters["CATALOG_CURRENCY_ID"] = array(			
			"NAME" => GetMessage("CP_SBB_TPL_CATALOG_CURRENCY_ID"),
			"TYPE" => "LIST",
...
if(empty($offers)) {
	...
	$arTemplateParameters["CATALOG_PRODUCT_DISPLAY_MODE"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_PRODUCT_DISPLAY_MODE"),
		"TYPE" => "LIST",
		"MULTIPLE" => "N",
		"ADDITIONAL_VALUES" => "N",
		"REFRESH" => "Y",
		"DEFAULT" => "N",
		"VALUES" => array(
			"N" => GetMessage("CP_SBB_TPL_CATALOG_PRODUCT_DISPLAY_MODE_SIMPLE"),
			"Y" => GetMessage("CP_SBB_TPL_CATALOG_PRODUCT_DISPLAY_MODE_EXT")
		)
	);
	...
	if(isset($arCurrentValues["CATALOG_PRODUCT_DISPLAY_MODE"]) && "Y" === $arCurrentValues["CATALOG_PRODUCT_DISPLAY_MODE"]) {
		$arTemplateParameters["CATALOG_OFFER_TREE_PROPS"] = array(			
			"NAME" => GetMessage("CP_SBB_TPL_CATALOG_OFFER_TREE_PROPS"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"ADDITIONAL_VALUES" => "N",
			"REFRESH" => "N",
	...
	$arTemplateParameters["CATALOG_OFFERS_CART_PROPERTIES"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_OFFERS_CART_PROPERTIES"),
		"TYPE" => "LIST",
		"MULTIPLE" => "Y",
...
$arTemplateParameters["CATALOG_USE_REVIEW"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_USE_REVIEW"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
	"REFRESH" => "Y",
);
...
if(isset($arCurrentValues["CATALOG_USE_REVIEW"]) && $arCurrentValues["CATALOG_USE_REVIEW"] === "Y") {	
	$arTemplateParameters["CATALOG_REVIEWS_IBLOCK_TYPE"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_IBLOCK_TYPE"),
		"TYPE" => "LIST",		
		"REFRESH" => "Y",
	...
	$arTemplateParameters["CATALOG_REVIEWS_IBLOCK_ID"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_IBLOCK_ID"),
		"TYPE" => "LIST",
		"REFRESH" => "Y",		
	...
	$arTemplateParameters["CATALOG_REVIEWS_NEWS_COUNT"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_NEWS_COUNT"),
		"TYPE" => "STRING",
		"DEFAULT" => "5",
	);
	
	$arTemplateParameters["CATALOG_REVIEWS_SORT_BY1"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_SORT_BY1"),
		"TYPE" => "LIST",
		"DEFAULT" => "sort",
	...
	$arTemplateParameters["CATALOG_REVIEWS_SORT_ORDER1"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_SORT_ORDER1"),
		"TYPE" => "LIST",
		"DEFAULT" => "asc",
		"VALUES" => array(
			"asc" => GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_SORT_ORDER_ASC"),
			"desc" => GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_SORT_ORDER_DESC"),
		),
		"ADDITIONAL_VALUES" => "Y",
	);
	
	$arTemplateParameters["CATALOG_REVIEWS_SORT_BY2"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_SORT_BY2"),
		"TYPE" => "LIST",
		"DEFAULT" => "active_from",
		"VALUES" => CIBlockParameters::GetElementSortFields(
			array("SHOWS", "SORT", "TIMESTAMP_X", "NAME", "ID", "ACTIVE_FROM", "ACTIVE_TO"),
	...
	$arTemplateParameters["CATALOG_REVIEWS_SORT_ORDER2"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_SORT_ORDER2"),
		"TYPE" => "LIST",
		"DEFAULT" => "desc",
		"VALUES" => array(
			"asc" => GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_SORT_ORDER_ASC"),
	...
	$arTemplateParameters["CATALOG_REVIEWS_ACTIVE_DATE_FORMAT"] = CIBlockParameters::GetDateFormat(GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_ACTIVE_DATE_FORMAT"), "ADDITIONAL_SETTINGS");

	$arTemplateParameters["CATALOG_REVIEWS_PROPERTY_CODE"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_REVIEWS_PROPERTY_CODE"),
		"TYPE" => "LIST",
		"MULTIPLE" => "Y",
	...
	$arTemplateParameters["CATALOG_MESS_REVIEWS_TAB"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MESS_REVIEWS_TAB"),
		"TYPE" => "STRING",
		"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_MESS_REVIEWS_TAB_DEFAULT")
	);
}

$arTemplateParameters["CATALOG_DISPLAY_COMPARE"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DISPLAY_COMPARE"),
	"TYPE" => "CHECKBOX",
	"REFRESH" => "Y",
	"DEFAULT" => "Y"
);
...
if(isset($arCurrentValues["CATALOG_DISPLAY_COMPARE"]) && $arCurrentValues["CATALOG_DISPLAY_COMPARE"] === "Y") {
	$arTemplateParameters["CATALOG_COMPARE_PATH"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_COMPARE_PATH"),
		"TYPE" => "STRING",
		"DEFAULT" => ""
	);
	$arTemplateParameters["CATALOG_MESS_BTN_COMPARE"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MESS_BTN_COMPARE"),
		"TYPE" => "STRING",
		"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_MESS_BTN_COMPARE_DEFAULT")
	);
	$arTemplateParameters["CATALOG_COMPARE_NAME"] = array(		
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_COMPARE_NAME"),
		"TYPE" => "STRING",
...
$arTemplateParameters["CATALOG_DETAIL_ADD_PICT_PROP"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_ADD_PICT_PROP"),
	"TYPE" => "LIST",
	"MULTIPLE" => "N",
	"ADDITIONAL_VALUES" => "N",
	"REFRESH" => "N",
...
if(!empty($offers)) {
	$arTemplateParameters["CATALOG_DETAIL_OFFER_ADD_PICT_PROP"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_OFFER_ADD_PICT_PROP"),
		"TYPE" => "LIST",
		"MULTIPLE" => "N",
		"ADDITIONAL_VALUES" => "N",
		"REFRESH" => "N",
...
$arTemplateParameters["CATALOG_DETAIL_PROPERTY_CODE"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_PROPERTY_CODE"),
	"TYPE" => "LIST",
	"MULTIPLE" => "Y",
	"ADDITIONAL_VALUES" => "Y",
	"VALUES" => $arAllPropList,
...
if(!empty($arCurrentValues["CATALOG_DETAIL_PROPERTY_CODE"])) {
	...
	$arTemplateParameters["CATALOG_DETAIL_MAIN_BLOCK_PROPERTY_CODE"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_MAIN_BLOCK_PROPERTY_CODE"),
		"TYPE" => "LIST",
		"MULTIPLE" => "Y",
...
if(!empty($offers)) {
	$arTemplateParameters["CATALOG_DETAIL_OFFERS_FIELD_CODE"] = CIBlockParameters::GetFieldCode(GetMessage("CP_SBB_TPL_CATALOG_DETAIL_OFFERS_FIELD_CODE"), "ADDITIONAL_SETTINGS");

	$arTemplateParameters["CATALOG_DETAIL_OFFERS_PROPERTY_CODE"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_OFFERS_PROPERTY_CODE"),
		"TYPE" => "LIST",
		"MULTIPLE" => "Y",
		"ADDITIONAL_VALUES" => "Y",
		"VALUES" => $arAllOfferPropList,
	...
	if(!empty($arCurrentValues["CATALOG_DETAIL_OFFERS_PROPERTY_CODE"])) {
		...
		$arTemplateParameters["CATALOG_DETAIL_MAIN_BLOCK_OFFERS_PROPERTY_CODE"] = array(
			"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_MAIN_BLOCK_OFFERS_PROPERTY_CODE"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"SIZE" => (count($selected) > 5 ? 8 : 3),
			"VALUES" => $selected
...
$arTemplateParameters["CATALOG_DETAIL_IMAGE_RESOLUTION"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_IMAGE_RESOLUTION"),
	"TYPE" => "LIST",
	"VALUES" => array(
		"16by9" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_IMAGE_RESOLUTION_16_BY_9"),
		"1by1" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_IMAGE_RESOLUTION_1_BY_1")
	),
	"DEFAULT" => "16by9"
);

$arTemplateParameters["CATALOG_DETAIL_ADD_DETAIL_TO_SLIDER"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_ADD_DETAIL_TO_SLIDER"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "N"
);

$arTemplateParameters["CATALOG_DETAIL_DETAIL_PICTURE_MODE"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_DETAIL_PICTURE_MODE"),
	"TYPE" => "LIST",
	"MULTIPLE" => "Y",
	"DEFAULT" => array("POPUP", "MAGNIFIER"),
	"VALUES" => array(
		"POPUP" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_DETAIL_PICTURE_MODE_POPUP"),
		"MAGNIFIER" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_DETAIL_PICTURE_MODE_MAGNIFIER"),
	)
);

$arTemplateParameters["CATALOG_DETAIL_SHOW_SLIDER"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_SHOW_SLIDER"),
	"TYPE" => "CHECKBOX",
	"MULTIPLE" => "N",
	"REFRESH" => "Y",
	"DEFAULT" => "N"
...
if(isset($arCurrentValues["CATALOG_DETAIL_SHOW_SLIDER"]) && $arCurrentValues["CATALOG_DETAIL_SHOW_SLIDER"] === "Y") {
	$arTemplateParameters["CATALOG_DETAIL_SLIDER_INTERVAL"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_SLIDER_INTERVAL"),
		"TYPE" => "TEXT",
		"MULTIPLE" => "N",
		"REFRESH" => "N",
		"DEFAULT" => "5000"
	...
	$arTemplateParameters["CATALOG_DETAIL_SLIDER_PROGRESS"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_DETAIL_SLIDER_PROGRESS"),
		"TYPE" => "CHECKBOX",
		"MULTIPLE" => "N",
		"REFRESH" => "N",
		"DEFAULT" => "N"
...
$arTemplateParameters["CATALOG_USE_GIFTS_DETAIL"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_USE_GIFTS_DETAIL"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
	"REFRESH" => "Y",
);
...
if($arCurrentValues["CATALOG_USE_GIFTS_DETAIL"] === "Y") {
	$arTemplateParameters["CATALOG_GIFTS_DETAIL_PAGE_ELEMENT_COUNT"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_GIFTS_DETAIL_PAGE_ELEMENT_COUNT"),
		"TYPE" => "STRING",
		"DEFAULT" => "5",
	);
	$arTemplateParameters["CATALOG_GIFTS_DETAIL_HIDE_BLOCK_TITLE"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_GIFTS_DETAIL_HIDE_BLOCK_TITLE"),
		"TYPE" => "CHECKBOX",
		"DEFAULT" => "",
	);
	$arTemplateParameters["CATALOG_GIFTS_DETAIL_BLOCK_TITLE"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_GIFTS_DETAIL_BLOCK_TITLE"),
		"TYPE" => "STRING",
		"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_GIFTS_DETAIL_BLOCK_TITLE_DEFAULT"),
	);
	$arTemplateParameters["CATALOG_GIFTS_DETAIL_TEXT_LABEL_GIFT"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_GIFTS_DETAIL_TEXT_LABEL_GIFT"),
		"TYPE" => "STRING",
		"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_GIFTS_DETAIL_TEXT_LABEL_GIFT_DEFAULT"),
	);
	$arTemplateParameters["CATALOG_GIFTS_MESS_BTN_BUY"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_GIFTS_MESS_BTN_BUY"),
		"TYPE" => "STRING",
		"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_GIFTS_MESS_BTN_BUY_DEFAULT")
	);
}

$arTemplateParameters["CATALOG_USE_STORE"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_USE_STORE"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "N",
	"REFRESH" => "Y",
);
...
if($catalogIncluded && $arCurrentValues["CATALOG_USE_STORE"] === "Y") {
	...
	$arTemplateParameters["CATALOG_STORES"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_STORES"),
		"TYPE" => "LIST",
		"MULTIPLE" => "Y",
		"VALUES" => $arStore,
		"ADDITIONAL_VALUES" => "Y"
	...
	$arTemplateParameters["CATALOG_USE_MIN_AMOUNT"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_USE_MIN_AMOUNT"),
		"TYPE" => "CHECKBOX",
		"DEFAULT" => "Y",
		"REFRESH" => "Y",
	);
	$arTemplateParameters["CATALOG_USER_FIELDS"] = array(
			"NAME" => GetMessage("CP_SBB_TPL_CATALOG_USER_FIELDS"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"ADDITIONAL_VALUES" => "Y",
			"VALUES" => $propertyUF,
	...
	$arTemplateParameters["CATALOG_FIELDS"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_FIELDS"),
		"TYPE"  => "LIST",
		"MULTIPLE" => "Y",
		"ADDITIONAL_VALUES" => "Y",
		"VALUES" => array(
			"TITLE"  => GetMessage("CP_SBB_TPL_CATALOG_TITLE"),
			"ADDRESS"  => GetMessage("CP_SBB_TPL_CATALOG_ADDRESS"),
			"DESCRIPTION"  => GetMessage("CP_SBB_TPL_CATALOG_DESCRIPTION"),
			"PHONE"  => GetMessage("CP_SBB_TPL_CATALOG_PHONE"),
			"SCHEDULE"  => GetMessage("CP_SBB_TPL_CATALOG_SCHEDULE"),
			"EMAIL"  => GetMessage("CP_SBB_TPL_CATALOG_EMAIL"),
			"IMAGE_ID"  => GetMessage("CP_SBB_TPL_CATALOG_IMAGE_ID"),
			"COORDINATES"  => GetMessage("CP_SBB_TPL_CATALOG_COORDINATES"),
		)
	);
	if($arCurrentValues["CATALOG_USE_MIN_AMOUNT"] != "N") {
		$arTemplateParameters["CATALOG_MIN_AMOUNT"] = array(
			"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MIN_AMOUNT"),
			"TYPE" => "STRING",
			"DEFAULT" => 5,
		);
	}
	$arTemplateParameters["CATALOG_SHOW_EMPTY_STORE"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_SHOW_EMPTY_STORE"),
		"TYPE" => "CHECKBOX",
		"DEFAULT" => "Y",
	);
	$arTemplateParameters["CATALOG_SHOW_GENERAL_STORE_INFORMATION"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_SHOW_GENERAL_STORE_INFORMATION"),
		"TYPE" => "CHECKBOX",
		"DEFAULT" => "N"
	);
	$arTemplateParameters["CATALOG_STORE_PATH"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_STORE_PATH"),
		"TYPE" => "STRING",
		"DEFAULT" => "/store/#store_id#",
	);
	$arTemplateParameters["CATALOG_MAIN_TITLE"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CATALOG_MAIN_TITLE"),
		"TYPE" => "STRING",
		"DEFAULT" => GetMessage("CP_SBB_TPL_CATALOG_MAIN_TITLE_DEFAULT"),
	);
}

$arTemplateParameters["CATALOG_SET_ITEMS_COUNT"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CATALOG_SET_ITEMS_COUNT"),
	"TYPE" => "STRING",
	"DEFAULT" => "3"
);
...
$arTemplateParameters["OBJECTS_USE_REVIEW"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_OBJECTS_USE_REVIEW"),
	"TYPE" => "CHECKBOX",
	"REFRESH" => "Y",
	"DEFAULT" => "Y"
);
...
if(isset($arCurrentValues["OBJECTS_USE_REVIEW"]) && $arCurrentValues["OBJECTS_USE_REVIEW"] === "Y") {
	$arTemplateParameters["OBJECTS_REVIEWS_IBLOCK_TYPE"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_OBJECTS_REVIEWS_IBLOCK_TYPE"),
		"TYPE" => "LIST",		
		"REFRESH" => "Y",
		"VALUES" => $arIBlockType,
	);
	...
	$arTemplateParameters["OBJECTS_REVIEWS_IBLOCK_ID"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_OBJECTS_REVIEWS_IBLOCK_ID"),
		"TYPE" => "LIST",
		"REFRESH" => "Y",		
...
$arTemplateParameters["CONTACTS_IBLOCK_TYPE"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CONTACTS_IBLOCK_TYPE"),
	"TYPE" => "LIST",		
	"REFRESH" => "Y",
	"VALUES" => $arIBlockType,
);
...
$arTemplateParameters["CONTACTS_IBLOCK_ID"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CONTACTS_IBLOCK_ID"),
	"TYPE" => "LIST",
	"REFRESH" => "Y",		
...
$arTemplateParameters["CONTACTS_USE_REVIEW"] = array(
	"NAME" => GetMessage("CP_SBB_TPL_CONTACTS_USE_REVIEW"),
	"TYPE" => "CHECKBOX",
	"REFRESH" => "Y",
	"DEFAULT" => "Y"
);
...
if(isset($arCurrentValues["CONTACTS_USE_REVIEW"]) && $arCurrentValues["CONTACTS_USE_REVIEW"] === "Y") {
	$arTemplateParameters["CONTACTS_REVIEWS_IBLOCK_TYPE"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CONTACTS_REVIEWS_IBLOCK_TYPE"),
		"TYPE" => "LIST",		
		"REFRESH" => "Y",
		"VALUES" => $arIBlockType,
	);
	...
	$arTemplateParameters["CONTACTS_REVIEWS_IBLOCK_ID"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CONTACTS_REVIEWS_IBLOCK_ID"),
		"TYPE" => "LIST",
		"REFRESH" => "Y",		
	...
	$arTemplateParameters["CONTACTS_REVIEWS_PAGE_LINK"] = array(
		"NAME" => GetMessage("CP_SBB_TPL_CONTACTS_REVIEWS_PAGE_LINK"),
		"TYPE" => "STRING",
