...
if(isset($arCurrentValues["USE_REVIEW"]) && $arCurrentValues["USE_REVIEW"] === "Y") {
	...
	$arTemplateParameters["REVIEWS_NEWS_COUNT"] = array(		
		"PARENT" => "REVIEW_SETTINGS",
		"NAME" => GetMessage("CP_BN_REVIEWS_NEWS_COUNT"),
		"TYPE" => "STRING",
		"DEFAULT" => "5",
	);	
	$arTemplateParameters["REVIEWS_SORT_BY1"] = array(		
		"PARENT" => "REVIEW_SETTINGS",
		"NAME" => GetMessage("CP_BN_REVIEWS_SORT_BY1"),
		"TYPE" => "LIST",
		"DEFAULT" => "SORT",
		"VALUES" => $arSort,
		"ADDITIONAL_VALUES" => "Y",
	...
	$arTemplateParameters["REVIEWS_SORT_ORDER1"] = array(		
		"PARENT" => "REVIEW_SETTINGS",
		"NAME" => GetMessage("CP_BN_REVIEWS_SORT_ORDER1"),
		"TYPE" => "LIST",
		"DEFAULT" => "ASC",
		"VALUES" => $arAscDesc,
		"ADDITIONAL_VALUES" => "Y",
	...
	$arTemplateParameters["REVIEWS_SORT_BY2"] = array(
		"PARENT" => "REVIEW_SETTINGS",
		"NAME" => GetMessage("CP_BN_REVIEWS_SORT_BY2"),
		"TYPE" => "LIST",
		"DEFAULT" => "ACTIVE_FROM",
		"VALUES" => $arSort,
		"ADDITIONAL_VALUES" => "Y",
	...
	$arTemplateParameters["REVIEWS_SORT_ORDER2"] = array(
		"PARENT" => "REVIEW_SETTINGS",
		"NAME" => GetMessage("CP_BN_REVIEWS_SORT_ORDER2"),
		"TYPE" => "LIST",
		"DEFAULT" => "DESC",
		"VALUES" => $arAscDesc,
		"ADDITIONAL_VALUES" => "Y",
	);
	$arTemplateParameters["REVIEWS_ACTIVE_DATE_FORMAT"] = CIBlockParameters::GetDateFormat(GetMessage("CP_BN_REVIEWS_ACTIVE_DATE_FORMAT"), "REVIEW_SETTINGS");
	$arTemplateParameters["REVIEWS_PROPERTY_CODE"] = array(		
		"PARENT" => "REVIEW_SETTINGS",	
		"NAME" => GetMessage("CP_BN_REVIEWS_PROPERTY_CODE"),
		"TYPE" => "LIST",
		"MULTIPLE" => "Y",
...
$arPromoProperty_LNS = array();
$rsProps = CIBlockProperty::GetList(
	array("SORT" => "ASC", "ID" => "ASC"),
	array("IBLOCK_ID" => $arCurrentValues["PROMOTIONS_IBLOCK_ID"], "ACTIVE" => "Y")
);
while($arProp = $rsProps->Fetch()) {
	if(in_array($arProp["PROPERTY_TYPE"], array("L", "N", "S", "E"))) {
		$arPromoProperty_LNS[$arProp["CODE"]] = "[".$arProp["CODE"]."] ".$arProp["NAME"];
	}
}
unset($arProp, $rsProps);

$arTemplateParameters["SHOW_PROMOTIONS"] = array(
	"NAME" => GetMessage("CP_BN_SHOW_PROMOTIONS"),
	"TYPE" => "CHECKBOX",
	"REFRESH" => "Y",
	"DEFAULT" => "Y",
);

if(isset($arCurrentValues["SHOW_PROMOTIONS"]) && $arCurrentValues["SHOW_PROMOTIONS"] === "Y") {
	...
	$arTemplateParameters["PROMOTIONS_NEWS_COUNT"] = array(		
		"NAME" => GetMessage("CP_BN_PROMOTIONS_NEWS_COUNT"),
		"TYPE" => "STRING",
		"DEFAULT" => "6",
	);	
	$arTemplateParameters["PROMOTIONS_SORT_BY1"] = array(		
		"NAME" => GetMessage("CP_BN_PROMOTIONS_SORT_BY1"),
		"TYPE" => "LIST",
		"DEFAULT" => "SORT",
		"VALUES" => $arSort,
		"ADDITIONAL_VALUES" => "Y",
	);	
	$arTemplateParameters["PROMOTIONS_SORT_ORDER1"] = array(		
		"NAME" => GetMessage("CP_BN_PROMOTIONS_SORT_ORDER1"),
		"TYPE" => "LIST",
		"DEFAULT" => "ASC",
		"VALUES" => $arAscDesc,
		"ADDITIONAL_VALUES" => "Y",
	);	
	$arTemplateParameters["PROMOTIONS_SORT_BY2"] = array(
		"NAME" => GetMessage("CP_BN_PROMOTIONS_SORT_BY2"),
		"TYPE" => "LIST",
		"DEFAULT" => "ACTIVE_TO",
		"VALUES" => $arSort,
		"ADDITIONAL_VALUES" => "Y",
	);	
	$arTemplateParameters["PROMOTIONS_SORT_ORDER2"] = array(
		"NAME" => GetMessage("CP_BN_PROMOTIONS_SORT_ORDER2"),
		"TYPE" => "LIST",
		"DEFAULT" => "nulls,DESC",
		"VALUES" => $arAscDesc,
		"ADDITIONAL_VALUES" => "Y",
	);	
	$arTemplateParameters["PROMOTIONS_PROPERTY_CODE"] = array(		
		"NAME" => GetMessage("CP_BN_PROMOTIONS_PROPERTY_CODE"),
		"TYPE" => "LIST",
		"MULTIPLE" => "Y",
		"VALUES" => $arPromoProperty_LNS,
		"ADDITIONAL_VALUES" => "Y",
	);
}
...
if(empty($offers)) {	
	...
	$arTemplateParameters["CATALOG_PRODUCT_DISPLAY_MODE"] = array(		
		...
		"DEFAULT" => "N",
		"VALUES" => array(
			"I" => GetMessage("CP_BN_CATALOG_PRODUCT_DISPLAY_MODE_INFO"),
