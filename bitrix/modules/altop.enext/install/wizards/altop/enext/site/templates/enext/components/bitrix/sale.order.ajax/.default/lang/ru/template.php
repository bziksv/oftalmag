...
$MESS["SOA_INVALID_PHONE"] = "Неправильный номер";
...
$MESS["SOA_ORDER_SUC"] = "Ваш заказ №#ORDER_ID# от #ORDER_DATE# успешно создан.";
$MESS["SOA_PAYMENT_SUC"] = "Номер вашей оплаты: №#PAYMENT_ID#";
$MESS["SOA_ORDER_SUC1"] = "<br /><br />
...
$MESS["SOA_ORDER_TO_BASKET"] = "Для завершения оформления других заказов перейдите в корзину";
$MESS["SOA_ORDER_BTN_TO_BASKET"] = "Перейти в корзину";
...
$MESS["CAPTCHA_REGF_PROMT"] = "Введите код";
...
$MESS["NAV_BACK_DEFAULT"] = "<i class='icon-arrow-left'></i>";
$MESS["NAV_FORWARD_DEFAULT"] = "<i class='icon-arrow-right'></i>";
...
$MESS["USE_COUPON_DEFAULT"] = "Введите купон на скидку";
...
$MESS["SOA_MIN_ORDER_SUM"] = "Минимальная сумма заказа";
?>
