                ...
                f = {
                    ...
                    _thumbCreator: {
                        create: function(i) {
                            var file = f.files[i],
                                ...
                                opts = {
                                    ...
                                    image: '<div class="jFiler-item-thumb-image fi-loading"><div class="jFiler-loader"><div><div></div></div></div></div>',
                        ...
                        generateIcon: function(obj) {
							var el = '<div class="jFiler-icon-file" data-type="' + (obj.extension && obj.extension.length > 0 ? obj.extension : '') + '"></div>';
                    ...
                    _onChange: function(e, d) {
						...
						if(!!form) {
							var inputCount = form.find('[name="' + n.name + '_COUNT"]');
							if(!!inputCount) {
								inputCount.val(f._itFl.length);
								form.formValidation('revalidateField', inputCount.attr('name'));
							}
						}
					},
                    ...
                    _remove: function(e, el) {
						...
						if(!!form) {
							var inputCount = form.find('[name="' + n.name + '_COUNT"]');
							if(!!inputCount) {
								inputCount.val(f._itFl.length > 0 ? f._itFl.length : '');
								form.formValidation('revalidateField', inputCount.attr('name'));
							}
						}
					},
