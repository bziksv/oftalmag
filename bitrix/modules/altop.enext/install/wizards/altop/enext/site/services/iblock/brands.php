...
$iblockCode = "enext_brands_".WIZARD_SITE_ID;
$iblockType = "catalog";
...
CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockType.".".$iblockID), array(
	"columns" => "NAME, PREVIEW_PICTURE, PROPERTY_".$arProperty["MARKER"].", PROPERTY_".$arProperty["COUNTRY"].", ACTIVE, SORT, TIMESTAMP_X, ID",
	"by" => "timestamp_x",
	"order" => "desc",
	"page_size" => "20"
));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/brands/index.php", array("ENEXT_BRANDS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/block_brands.php", array("ENEXT_BRANDS_IBLOCK_ID" => $iblockID));?>