...
if($iblockExists) {
	...
	$arTemplateParameters['PRODUCT_ROW_VARIANTS'] = array(
		...
		'JS_FILE' => SaleProductsGiftSectionComponent::getSettingsScript($templateFolder, 'dragdrop_add'),
		...
		'DEFAULT' => Json::encode(SaleProductsGiftSectionComponent::predictRowVariants(4, $pageElementCount))
	);
