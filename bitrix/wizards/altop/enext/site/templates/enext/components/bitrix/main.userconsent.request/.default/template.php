...
<script type="text/javascript">
	...
	BX.UserConsent = {
		msg: {
			'title': '<?=GetMessage("MAIN_USER_CONSENT_REQUEST_TITLE")?>',
			'btnAccept': '<?=GetMessage("MAIN_USER_CONSENT_REQUEST_BTN_ACCEPT")?>',
			'btnReject': '<?=GetMessage("MAIN_USER_CONSENT_REQUEST_BTN_REJECT")?>',
			'loading': '<?=GetMessage("MAIN_USER_CONSENT_REQUEST_LOADING")?>',
			'errTextLoad': '<?=GetMessage("MAIN_USER_CONSENT_REQUEST_ERR_TEXT_LOAD")?>'
		},
		events: {
