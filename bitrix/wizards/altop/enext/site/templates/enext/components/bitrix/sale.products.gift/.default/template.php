...
$arParams["GIFTS_MESS_BTN_BUY"] = $arParams["GIFTS_MESS_BTN_BUY"] ?: Loc::getMessage("CT_SPG_TPL_GIFTS_MESS_BTN_BUY");
$arParams["MESS_BTN_DETAIL"] = $arParams["MESS_BTN_DETAIL"] ?: Loc::getMessage("CT_SPG_TPL_MESS_BTN_DETAIL");
$arParams["MESS_BTN_DELAY"] = $arParams["MESS_BTN_DELAY"] ?: Loc::getMessage("CT_SPG_TPL_MESS_BTN_DELAY");
...
$arParams["GIFTS_MESS_BTN_ADD_TO_BASKET"] = $arParams["GIFTS_MESS_BTN_ADD_TO_BASKET"] ?: Loc::getMessage("CT_SPG_TPL_GIFTS_MESS_BTN_ADD_TO_BASKET");
...
$containerName = "sale-products-gift-".(isset($arParams["POPUP_MODE"]) && $arParams["POPUP_MODE"] == "Y" ? "popup-" : "")."container";?>
...
<script type="text/javascript">
	BX.message({
		...
		SPG_ADD_BASKET_OK_MESSAGE: '<?=GetMessageJS("CT_SPG_TPL_MESS_BTN_ADD_TO_BASKET_OK")?>',
		SPG_BTN_MESSAGE_DETAIL_ITEM: '<?=GetMessageJS("CT_SPG_TPL_MESS_BTN_DETAIL_ITEM")?>'
	});
