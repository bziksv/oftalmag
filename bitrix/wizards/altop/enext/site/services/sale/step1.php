...
COption::SetOptionString("enext", "shopLocalization", $shopLocalization, "ru", WIZARD_SITE_ID);
...
if($bRus || COption::GetOptionString("enext", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA) {
	...
	if($shopLocalization == "ru") {
		...
		COption::SetOptionString("enext", "shopLocation", $shopLocation, false, WIZARD_SITE_ID);
		$shopOfName = $wizard->GetVar("shopOfName");
		COption::SetOptionString("enext", "shopOfName", $shopOfName, false, WIZARD_SITE_ID);
		$shopAdr = $wizard->GetVar("shopAdr");
		COption::SetOptionString("enext", "shopAdr", $shopAdr, false, WIZARD_SITE_ID);

		$shopINN = $wizard->GetVar("shopINN");
		COption::SetOptionString("enext", "shopINN", $shopINN, false, WIZARD_SITE_ID);
		$shopKPP = $wizard->GetVar("shopKPP");
		COption::SetOptionString("enext", "shopKPP", $shopKPP, false, WIZARD_SITE_ID);
		$shopNS = $wizard->GetVar("shopNS");
		COption::SetOptionString("enext", "shopNS", $shopNS, false, WIZARD_SITE_ID);
		$shopBANK = $wizard->GetVar("shopBANK");
		COption::SetOptionString("enext", "shopBANK", $shopBANK, false, WIZARD_SITE_ID);
		$shopBANKREKV = $wizard->GetVar("shopBANKREKV");
		COption::SetOptionString("enext", "shopBANKREKV", $shopBANKREKV, false, WIZARD_SITE_ID);
		$shopKS = $wizard->GetVar("shopKS");
		COption::SetOptionString("enext", "shopKS", $shopKS, false, WIZARD_SITE_ID);
		...
		COption::SetOptionString("enext", "shopLocation_ua", $shopLocation, false, WIZARD_SITE_ID);
		$shopOfName = $wizard->GetVar("shopOfName_ua");
		COption::SetOptionString("enext", "shopOfName_ua", $shopOfName, false, WIZARD_SITE_ID);
		$shopAdr = $wizard->GetVar("shopAdr_ua");
		COption::SetOptionString("enext", "shopAdr_ua", $shopAdr, false, WIZARD_SITE_ID);

		$shopEGRPU_ua = $wizard->GetVar("shopEGRPU_ua");
		COption::SetOptionString("enext", "shopEGRPU_ua", $shopEGRPU_ua, false, WIZARD_SITE_ID);
		$shopINN_ua = $wizard->GetVar("shopINN_ua");
		COption::SetOptionString("enext", "shopINN_ua", $shopINN_ua, false, WIZARD_SITE_ID);
		$shopNDS_ua = $wizard->GetVar("shopNDS_ua");
		COption::SetOptionString("enext", "shopNDS_ua", $shopNDS_ua, false, WIZARD_SITE_ID);
		$shopNS_ua = $wizard->GetVar("shopNS_ua");
		COption::SetOptionString("enext", "shopNS_ua", $shopNS_ua, false, WIZARD_SITE_ID);
		$shopBank_ua = $wizard->GetVar("shopBank_ua");
		COption::SetOptionString("enext", "shopBank_ua", $shopBank_ua, false, WIZARD_SITE_ID);
		$shopMFO_ua = $wizard->GetVar("shopMFO_ua");
		COption::SetOptionString("enext", "shopMFO_ua", $shopMFO_ua, false, WIZARD_SITE_ID);
		$shopPlace_ua = $wizard->GetVar("shopPlace_ua");
		COption::SetOptionString("enext", "shopPlace_ua", $shopPlace_ua, false, WIZARD_SITE_ID);
		$shopFIO_ua = $wizard->GetVar("shopFIO_ua");
		COption::SetOptionString("enext", "shopFIO_ua", $shopFIO_ua, false, WIZARD_SITE_ID);
		$shopTax_ua = $wizard->GetVar("shopTax_ua");
		COption::SetOptionString("enext", "shopTax_ua", $shopTax_ua, false, WIZARD_SITE_ID);
	}
	
	$shopEmail = $wizard->GetVar("shopEmail");
	COption::SetOptionString("enext", "shopEmail", $shopEmail, false, WIZARD_SITE_ID);
	...
	if(strlen($siteStamp) > 0) {
		if(IntVal($siteStamp) > 0) {
			...
			if($zr = $ff->Fetch()) {
				...
				COption::SetOptionString("enext", "siteStamp", $siteStamp, false, WIZARD_SITE_ID);
			}
		}
	}
	...
	COption::SetOptionString("enext", "personTypeFiz", $personTypeFiz, false, WIZARD_SITE_ID);
	$personTypeUr = (isset($personType["ur"]) && $personType["ur"] == "Y" ? "Y" : "N");
	COption::SetOptionString("enext", "personTypeUr", $personTypeUr, false, WIZARD_SITE_ID);
	...
	if($shopLocalization == "ua") {
		...
		COption::SetOptionString("enext", "personTypeFizUa", $personTypeFizUa, false, WIZARD_SITE_ID);
		...
		if(\Bitrix\Main\Config\Option::get("sale", "sale_locationpro_migrated", "") == "Y") {
			...
			if(strlen($shopLocation)) {
				...
				if($item)
					...
					require($_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/locations/country_codes.php");
	...
	if($personType["fiz"] == "Y" && $shopLocalization != "ua") {
		if($bRus) {
			...
			$logo = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH ."/images/paysystem/yandex_cards.png";
			...
			$logo = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH ."/images/paysystem/yandex_terminals.png";
			$arPicture = CFile::MakeFileArray($logo);
			$arPaySystems[] = array(
				"PAYSYSTEM" => array(
	...
	if(COption::GetOptionString("enext", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA) {
		...
		function __MakeOrder(array $arData, array $productFilter, $prdCnt = 1) {
			...
			while($prdCnt > 0) {
				...
				unset($_SESSION['BUY_ADD_PRODUCT']['LIST_PRODUCT_ID'][$arData['SITE_ID']][$product['ID']]);
			}
