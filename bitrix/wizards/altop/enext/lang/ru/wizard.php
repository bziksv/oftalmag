<?
$MESS["WIZ_TEMPLATE_NAME"] = "ЭЛЕКТРОСИЛА NEXT";
...
$MESS["WIZ_SITE_NAME"] = "Название веб-сайта";
$MESS["WIZ_SITE_NAME_DEF"] = "ЭЛЕКТРОСИЛА NEXT";
$MESS["WIZ_SITE_EMAIL"] = "E-Mail адрес по умолчанию";
$MESS["WIZ_REWRITE_INDEX_DESC"] = "Изменение главной страницы";
$MESS["wiz_site_name"] = "Быстрый интернет-магазин на 1С-Битрикс";
...
$MESS["WIZ_SHOP_LOCATION_DEF"] = "Новгород";
...
$MESS["WIZ_SHOP_OF_NAME_DEF"] = "ООО \"Корпоративный Стандарт\"";
...
$MESS["WIZ_SHOP_ADR_DEF"] = "ул. Славная 51";
...
$MESS["WIZ_SHOP_PRICE_BASE_TEXT1"] = "В решении ЭЛЕКТРОСИЛА NEXT используется в качестве публичных цен для просмотра и покупки базовая цена (BASE). В текущий момент для группы \"Все пользователи (в том числе неавторизованные)\" включено право на данный тип цены. Таким образом данная группа будет видеть цены в решении.";
...
$MESS["WSL_STEP2_GFILE_RU"] = "Россия";
$MESS["WSL_STEP2_GFILE_BY"] = "Беларусь";
