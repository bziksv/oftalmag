...
class SelectTemplateStep extends CSelectTemplateWizardStep {
	...
	function OnPostForm() {
		...
		if($wizard->IsNextButtonClick()) {
			...
			if(in_array($templateID, $arTemplates))
				$wizard->SetVar("templateID", "enext");
		}
	}
	...
	function ShowStep() {
		...
		if(in_array("enext", array_keys($arTemplates))) {
			$arTemplateOrder[] = "enext";
		}

		$defaultTemplateID = COption::GetOptionString("main", "wizard_template_id", "enext", $wizard->GetVar("siteID"));
		if(!in_array($defaultTemplateID, array("enext"))) $defaultTemplateID = "enext";
		...
		$arTemplateInfo = array(
			"enext" => array(
				...
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/site/templates/enext/lang/".LANGUAGE_ID."/preview.png",
				"SCREENSHOT" => $wizard->GetPath()."/site/templates/enext/lang/".LANGUAGE_ID."/screen.png",
			),
		);
...
class SiteSettingsStep extends CSiteSettingsWizardStep{
	function InitStep() {
		...
		if((COption::GetOptionString("enext", "wizard_installed", "N", $siteID) == "Y" && defined("WIZARD_INSTALL_DEMO_DATA") && !WIZARD_INSTALL_DEMO_DATA) || defined("ADDITIONAL_INSTALL")) {
		...
		$wizard->SetDefaultVars(
			Array(
				...
				"siteEmail" => COption::GetOptionString("enext", "siteEmail", "info@".$_SERVER["SERVER_NAME"], $siteID)
			)
		);
	}
...
class ShopSettings extends CWizardStep {
	function InitStep() {
		...
		$wizard->SetDefaultVars(
			Array(
				"shopLocalization" => COption::GetOptionString("enext", "shopLocalization", "ru", $siteID),
				"shopEmail" => COption::GetOptionString("enext", "shopEmail", "info@".$_SERVER["SERVER_NAME"], $siteID),
				"shopOfName" => COption::GetOptionString("enext", "shopOfName", GetMessage("WIZ_SHOP_OF_NAME_DEF"), $siteID),
				"shopLocation" => COption::GetOptionString("enext", "shopLocation", GetMessage("WIZ_SHOP_LOCATION_DEF"), $siteID),
				"shopAdr" => COption::GetOptionString("enext", "shopAdr", GetMessage("WIZ_SHOP_ADR_DEF"), $siteID),
				"shopINN" => COption::GetOptionString("enext", "shopINN", "1234567890", $siteID),
				"shopKPP" => COption::GetOptionString("enext", "shopKPP", "123456789", $siteID),
				"shopNS" => COption::GetOptionString("enext", "shopNS", "0000 0000 0000 0000 0000", $siteID),
				"shopBANK" => COption::GetOptionString("enext", "shopBANK", GetMessage("WIZ_SHOP_BANK_DEF"), $siteID),
				"shopBANKREKV" => COption::GetOptionString("enext", "shopBANKREKV", GetMessage("WIZ_SHOP_BANKREKV_DEF"), $siteID),
				"shopKS" => COption::GetOptionString("enext", "shopKS", "30101 810 4 0000 0000225", $siteID),
				
				"shopOfName_ua" => COption::GetOptionString("enext", "shopOfName_ua", GetMessage("WIZ_SHOP_OF_NAME_DEF_UA"), $siteID),
				"shopLocation_ua" => COption::GetOptionString("enext", "shopLocation_ua", GetMessage("WIZ_SHOP_LOCATION_DEF_UA"), $siteID),
				"shopAdr_ua" => COption::GetOptionString("enext", "shopAdr_ua", GetMessage("WIZ_SHOP_ADR_DEF_UA"), $siteID),
				"shopEGRPU_ua" =>  COption::GetOptionString("enext", "shopEGRPU_ua", "", $siteID),
				"shopINN_ua" =>  COption::GetOptionString("enext", "shopINN_ua", "", $siteID),
				"shopNDS_ua" =>  COption::GetOptionString("enext", "shopNDS_ua", "", $siteID),
				"shopNS_ua" =>  COption::GetOptionString("enext", "shopNS_ua", "", $siteID),
				"shopBank_ua" =>  COption::GetOptionString("enext", "shopBank_ua", "", $siteID),
				"shopMFO_ua" =>  COption::GetOptionString("enext", "shopMFO_ua", "", $siteID),
				"shopPlace_ua" =>  COption::GetOptionString("enext", "shopPlace_ua", "", $siteID),
				"shopFIO_ua" =>  COption::GetOptionString("enext", "shopFIO_ua", "", $siteID),
				"shopTax_ua" =>  COption::GetOptionString("enext", "shopTax_ua", "", $siteID),

				"installPriceBASE" => COption::GetOptionString("enext", "installPriceBASE", "Y", $siteID),
			)
		);
	}
	...
	function InitStep()
	{
		...
		if($shopLocalization == "ua")
			...
			$wizard->SetDefaultVars(
				Array(
					"personType" => Array(
						"fiz" =>  COption::GetOptionString("enext", "personTypeFiz", "Y", $siteID),
						"ur" => COption::GetOptionString("enext", "personTypeUr", "Y", $siteID),
					)
				)
			);
	}
...
class PaySystem extends CWizardStep {
	...
	function ShowStep() {
		...
		if(LANGUAGE_ID != "ru" || LANGUAGE_ID == "ru" && (COption::GetOptionString("enext", "wizard_installed", "N", $siteID) != "Y" || $shopLocalization == "ru" && ($arAutoDeliveries["russianpost"] != "Y" || $arAutoDeliveries["rus_post"] != "Y" || $arAutoDeliveries["rus_post_first"] != "Y") || $shopLocalization == "ua" && ($arAutoDeliveries["ua_post"] != "Y") || $shopLocalization == "kz" && ($arAutoDeliveries["kaz_post"] != "Y"))) {
			$this->content .= "
			<div class='wizard-input-form-block'>
				<div class='wizard-catalog-title'>".GetMessage("WIZ_DELIVERY_TITLE")."</div>
				<div>
					<div class='wizard-input-form-field wizard-input-form-field-checkbox'>";
						if(COption::GetOptionString("enext", "wizard_installed", "N", $siteID) != "Y") {
